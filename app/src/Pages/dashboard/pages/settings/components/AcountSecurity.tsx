   ...
   <div className={styles.Profile}>
      ...
      <div className={styles.mainContainer}>
        <div className={styles.side}>
          <ul>
            <li className={active === "profile" && styles.active } onClick={ () => handleClickNav("profile")}>My Profile</li>
            <li className={active === "Security" && styles.active } onClick={ () => handleClickNav("Security")}>Security</li>
            <li className={active === "notification" && styles.active } onClick={ () => handleClickNav("notification")}>Notification</li>
            <li className={active === "history" && styles.active } onClick={ () => handleClickNav("history")}>Activity History</li>
            <li className={active === "stats" && styles.active } onClick={ () => handleClickNav("stats")}>Learning Stats</li>
            <li className={active === "billing" && styles.active } onClick={ () => handleClickNav("billing")}>Billing</li>
            <li id="delete" onClick={ () => handleClickNav("delete")}>Delete Account</li>
          </ul>
        </div>
